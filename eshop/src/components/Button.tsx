...
export const Button = <C extends React.ElementType>({ className, bg = "red", component, children, ...props }: ButtonProps<C>) => {
  ...
  const bgClasses = bg === "red" ? "bg-christmasRed text-white focus:outline-christmasRed" : bg === "beige" ? "bg-christmasBeigeAccent text-christmasDark focus:outline-christmasBeigeAccent" : bg === "green" ? "bg-christmasGreen text-white focus:outline-christmasGreen" : "";
